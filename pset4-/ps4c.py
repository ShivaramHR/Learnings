...
def decrypt_message_try_pads(ciphertext, pads):
    ...
    for pad in pads:
        # decrypt using this pad
        decrypted_text = ciphertext.decrypt(pad)
    ...
    return ps4b.PlaintextMessage(best_message, best_pad)
...
def decode_story():
    ...
    # decrypt using the best pad
    decrypted_message = decrypt_message_try_pads(encrypted_story, pads)
